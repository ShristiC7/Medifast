...
import { ArrowLeft, Check, Star, Users, TrendingUp, Truck, Phone, Shield, Heart, Stethoscope, Activity } from "lucide-react";
...
export function SubscriptionPage({ onBack }: SubscriptionPageProps) {
  ...
  const handleJoinNow = () => {
    // This would connect to payment/subscription flow
    console.log('Starting subscription flow for:', selectedPlan);
  };
